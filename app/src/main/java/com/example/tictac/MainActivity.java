...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im=findViewById(R.id.snakeImage);
        plyr1 = (EditText) findViewById(R.id.playerOneName);
        plyr2 = (EditText) findViewById(R.id.playerTwoName);
        ...
        Animation file_animation= AnimationUtils.loadAnimation(this,R.anim.file_animation);
        im.startAnimation(file_animation);
    ...
    public void addItemToDifficultySpinner() {
        ...
        difficulty.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String temp = difficulty.getItemAtPosition(position).toString();
